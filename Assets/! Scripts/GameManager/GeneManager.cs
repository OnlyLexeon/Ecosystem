...
public class GeneManager : MonoBehaviour
{
    ...
    public void LoadCustomGenes()
    {
        if (File.Exists(saveFilePath))
        {
            ...
            foreach (Genes geneData in wrapper.genes)
            {
                ...
                Genes gene = new Genes(geneData.name, geneData.description, geneData.positivity, geneData.weightage,statModifiers);
    ...
    //Adding
    public void AddNewGene(string name, string description, Positivity positivity, int weightage, List<StatModifier> statModifiers)
    {
        Genes newGene = new Genes(name, description, positivity, weightage, statModifiers);
...
public class Genes
{
    ...
    public Genes(string name, string description, Positivity positivity, int weightage, List<StatModifier> statModifiers)
    {
        this.name = name;
